...
interface SidebarProps {
  ...
  onThemeChange: (theme: "default" | "unibe" | "unphu" | "rosario") => void;
}
...
export default function Sidebar({
  ...
  <div className="mb-5">
    ...
    <select
      ...
      onChange={(event) =>
        onThemeChange(
          event.target.value as "default" | "unibe" | "unphu" | "rosario"
        )
      }
  ...
  <div className="space-y-2">
    <button
      ...
      onClick={onUndo}
      disabled={!canUndo}
      className="w-full rounded border border-blue-400-600 px-4 py-2 text-blue-800 hover:bg-blue-50 disabled:cursor-not-allowed disabled:opacity-40"
    >
      Deshacer
    </button>
    ...
    <button
      type="button"
      onClick={onExport}
      className="w-full rounded border border-blue-400-600 px-4 py-2 text-blue-800 hover:bg-blue-50"
    >
      Exportar HTML
    </button>
